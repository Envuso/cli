...
@envuso/cli/0.2.0 darwin-arm64 node-v16.0.0
$ envuso --help [COMMAND]
USAGE
  $ envuso COMMAND
...
...
_See code: [lib/commands/generate-app-key.js](https://github.com/envuso/cli/blob/v0.2.0/lib/commands/generate-app-key.js)_
...
_See code: [lib/commands/make/controller.js](https://github.com/envuso/cli/blob/v0.2.0/lib/commands/make/controller.js)_
...
_See code: [lib/commands/make/middleware.js](https://github.com/envuso/cli/blob/v0.2.0/lib/commands/make/middleware.js)_
...
_See code: [lib/commands/make/model.js](https://github.com/envuso/cli/blob/v0.2.0/lib/commands/make/model.js)_
...
_See code: [lib/commands/new.js](https://github.com/envuso/cli/blob/v0.2.0/lib/commands/new.js)_
<!-- commandsstop -->
