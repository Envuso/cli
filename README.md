...
@envuso/cli/0.1.2 darwin-arm64 node-v16.0.0
$ envuso --help [COMMAND]
USAGE
  $ envuso COMMAND
...
...
_See code: [src/commands/generate-app-key.ts](https://github.com/envuso/cli/blob/v0.1.2/src/commands/generate-app-key.ts)_
...
_See code: [src/commands/make/controller.ts](https://github.com/envuso/cli/blob/v0.1.2/src/commands/make/controller.ts)_
...
_See code: [src/commands/make/middleware.ts](https://github.com/envuso/cli/blob/v0.1.2/src/commands/make/middleware.ts)_
...
_See code: [src/commands/make/model.ts](https://github.com/envuso/cli/blob/v0.1.2/src/commands/make/model.ts)_
...
_See code: [src/commands/new.ts](https://github.com/envuso/cli/blob/v0.1.2/src/commands/new.ts)_
<!-- commandsstop -->
